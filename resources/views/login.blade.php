        ...
        <div class="card">
            <div class="card-body login-card-body shadow-100">
                ...
                <form id="login-form" method="POST" action="{{ admin_url('auth/login') }}">
                    ...
                    <fieldset class="form-label-group form-group position-relative has-icon-left">
                        ...
                        @if($errors->has('username'))
                            <span class="invalid-feedback text-danger" role="alert">
                                    ...
                                    <span class="control-label" for="inputError">ssssssssssss<i class="feather icon-x-circle"></i> {{$message}}</span><br>
                                @endforeach
                                        </span>
                        @endif
                    </fieldset>
                    ...
                    <button type="submit" class="btn btn-primary float-right login-btn" id="login-btn">
...
Dcat.ready(function () {
    ...
    $('#login-form').form({
        ...
        before: function (fields, form, opt) {
        	return Dcat.loginFormBefore(fields, form, opt)    
        },
        error:function(response){
        	Dcat.loginFormErrors(response)
        }
    });
});
</script>
